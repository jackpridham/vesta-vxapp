...
echo myvesta_get_element('button_gray', '', 'wordpress_install', __('Install WordPress'), null, 'width: 300px;', 'add');
...
if ($is_wordpress_installed == '1') {
    ...
    if ($is_wordpress_locked == '0') {$disabled = false; $add_style = ''; $link_text = ''; $link_url = '';}
    ...
    if ($is_wordpress_locked == '1') {$disabled = false; $add_style = ''; $link_text = ''; $link_url = '';}
    else {$disabled = true; $add_style = 'background-color: #ccc;'; $link_text = ''; $link_url = '';}
    ...
    // Add admin user
    echo myvesta_get_element('button_gray', '', 'wordpress_add_admin_user', __('Add WordPress Admin User'), null, 'width: 300px;', 'add');

    // Clone
    echo myvesta_get_element('button_gray', '', 'wordpress_clone_step1', __('Clone WordPress'), null, 'width: 300px;', 'add');
