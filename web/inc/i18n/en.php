...
$LANG['en'] = array(
    ...
    'Install Docker from the panel to start managing containers.' => 'Install Docker from the panel to start managing containers.',
    ...
    'Add Docker container' => 'Add Docker container',
    'Docker container logs' => 'Docker container logs',
    'Docker container inspect' => 'Docker container inspect',
    'Docker remove output' => 'Docker remove output',
    'Docker installation output' => 'Docker installation output',
    'Are you sure you want to remove Docker container %s?' => 'Are you sure you want to remove Docker container %s?',
    ...
    'Degraded' => 'Degraded',
    'Unhealthy' => 'Unhealthy',
    'Only domains owned by this user can be routed to this container' => 'Only domains owned by this user can be routed to this container',
    'Only managed bind roots under /home/<user>/docker are allowed' => 'Only managed bind roots under /home/<user>/docker are allowed',
    'Docker container name may only contain lowercase letters, numbers, and hyphens.' => 'Docker container name may only contain lowercase letters, numbers, and hyphens.',
    'Container port must be between 1 and 65535.' => 'Container port must be between 1 and 65535.',
    'Route path must start with / and may not contain spaces, ? or #.' => 'Route path must start with / and may not contain spaces, ? or #.',
    'Restart policy is invalid.' => 'Restart policy is invalid.',
    'Health check type is invalid.' => 'Health check type is invalid.',
    'Health check interval must be between 15 and 3600 seconds.' => 'Health check interval must be between 15 and 3600 seconds.',
    'Health check target must be a full http:// or https:// URL.' => 'Health check target must be a full http:// or https:// URL.',
    'Health check target is required for TCP checks.' => 'Health check target is required for TCP checks.',
    'Health check target must use host:port for TCP checks.' => 'Health check target must use host:port for TCP checks.',
    ...
    'Lock WordPress' => 'Lock WordPress modifications',
    'Unlock WordPress' => 'Unlock WordPress modifications',
    'WordPress cloning' => 'WordPress cloning',
    'Clone WordPress' => 'Clone WordPress',
