...
From the deployment client, require `dev.jackpridham.com` to resolve to the
authorized development address `192.168.200.100` and require the panel
...
Stage control-plane files to `debian@dev.jackpridham.com` over the authorized
