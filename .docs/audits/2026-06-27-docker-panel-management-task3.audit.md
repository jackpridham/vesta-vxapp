...
This audit validates Task 3 of [.docs/plans/2026-06-27-docker-panel-management.md](../../.docs/plans/2026-06-27-docker-panel-management.md) against the landed persistence, reporting, and admin-panel files:

- [bin/v-add-user](../../bin/v-add-user)
- [bin/v-change-user-package](../../bin/v-change-user-package)
- [bin/v-list-user-package](../../bin/v-list-user-package)
- [bin/v-update-user-package](../../bin/v-update-user-package)
- [bin/v-list-user](../../bin/v-list-user)
- [bin/v-list-users](../../bin/v-list-users)
- [bin/v-update-user-counters](../../bin/v-update-user-counters)
- [bin/v-update-user-stats](../../bin/v-update-user-stats)
- [func/main.sh](../../func/main.sh)
- [web/add/package/index.php](../../web/add/package/index.php)
- [web/edit/package/index.php](../../web/edit/package/index.php)
- [web/templates/admin/add_package.html](../../web/templates/admin/add_package.html)
- [web/templates/admin/edit_package.html](../../web/templates/admin/edit_package.html)
- [web/templates/admin/list_packages.html](../../web/templates/admin/list_packages.html)
- [web/templates/admin/list_user.html](../../web/templates/admin/list_user.html)
- [web/templates/admin/edit_user.html](../../web/templates/admin/edit_user.html)
- [install/debian/9/packages/default.pkg](../../install/debian/9/packages/default.pkg)
- [install/debian/9/packages/gainsboro.pkg](../../install/debian/9/packages/gainsboro.pkg)
- [install/debian/9/packages/palegreen.pkg](../../install/debian/9/packages/palegreen.pkg)
- [install/debian/9/packages/slategrey.pkg](../../install/debian/9/packages/slategrey.pkg)
- [install/debian/10/packages/default.pkg](../../install/debian/10/packages/default.pkg)
- [install/debian/11/packages/default.pkg](../../install/debian/11/packages/default.pkg)
- [install/debian/12/packages/default.pkg](../../install/debian/12/packages/default.pkg)
- [install/debian/13/packages/default.pkg](../../install/debian/13/packages/default.pkg)
- [example-of-linux-root-folder/usr/local/vesta/data/packages/default.pkg](../../example-of-linux-root-folder/usr/local/vesta/data/packages/default.pkg)
- [example-of-linux-root-folder/usr/local/vesta/data/users/admin/user.conf](../../example-of-linux-root-folder/usr/local/vesta/data/users/admin/user.conf)
- [example-of-linux-root-folder/usr/local/vesta/data/users/test/user.conf](../../example-of-linux-root-folder/usr/local/vesta/data/users/test/user.conf)

The companion sanitized snapshot is [.docs/audits/2026-06-27-docker-panel-management-task3.audit-input.md](../../.docs/audits/2026-06-27-docker-panel-management-task3.audit-input.md).
