...
This audit validates Task 3 of [.docs/plans/2026-06-27-docker-panel-management.md](/home/jackpridham/Work/vesta-vxapp/.docs/plans/2026-06-27-docker-panel-management.md) against the landed persistence, reporting, and admin-panel files:

- [bin/v-add-user](/home/jackpridham/Work/vesta-vxapp/bin/v-add-user)
- [bin/v-change-user-package](/home/jackpridham/Work/vesta-vxapp/bin/v-change-user-package)
- [bin/v-list-user-package](/home/jackpridham/Work/vesta-vxapp/bin/v-list-user-package)
- [bin/v-update-user-package](/home/jackpridham/Work/vesta-vxapp/bin/v-update-user-package)
- [bin/v-list-user](/home/jackpridham/Work/vesta-vxapp/bin/v-list-user)
- [bin/v-list-users](/home/jackpridham/Work/vesta-vxapp/bin/v-list-users)
- [bin/v-update-user-counters](/home/jackpridham/Work/vesta-vxapp/bin/v-update-user-counters)
- [bin/v-update-user-stats](/home/jackpridham/Work/vesta-vxapp/bin/v-update-user-stats)
- [func/main.sh](/home/jackpridham/Work/vesta-vxapp/func/main.sh)
- [web/add/package/index.php](/home/jackpridham/Work/vesta-vxapp/web/add/package/index.php)
- [web/edit/package/index.php](/home/jackpridham/Work/vesta-vxapp/web/edit/package/index.php)
- [web/templates/admin/add_package.html](/home/jackpridham/Work/vesta-vxapp/web/templates/admin/add_package.html)
- [web/templates/admin/edit_package.html](/home/jackpridham/Work/vesta-vxapp/web/templates/admin/edit_package.html)
- [web/templates/admin/list_packages.html](/home/jackpridham/Work/vesta-vxapp/web/templates/admin/list_packages.html)
- [web/templates/admin/list_user.html](/home/jackpridham/Work/vesta-vxapp/web/templates/admin/list_user.html)
- [web/templates/admin/edit_user.html](/home/jackpridham/Work/vesta-vxapp/web/templates/admin/edit_user.html)
- [install/debian/9/packages/default.pkg](/home/jackpridham/Work/vesta-vxapp/install/debian/9/packages/default.pkg)
- [install/debian/9/packages/gainsboro.pkg](/home/jackpridham/Work/vesta-vxapp/install/debian/9/packages/gainsboro.pkg)
- [install/debian/9/packages/palegreen.pkg](/home/jackpridham/Work/vesta-vxapp/install/debian/9/packages/palegreen.pkg)
- [install/debian/9/packages/slategrey.pkg](/home/jackpridham/Work/vesta-vxapp/install/debian/9/packages/slategrey.pkg)
- [install/debian/10/packages/default.pkg](/home/jackpridham/Work/vesta-vxapp/install/debian/10/packages/default.pkg)
- [install/debian/11/packages/default.pkg](/home/jackpridham/Work/vesta-vxapp/install/debian/11/packages/default.pkg)
- [install/debian/12/packages/default.pkg](/home/jackpridham/Work/vesta-vxapp/install/debian/12/packages/default.pkg)
- [install/debian/13/packages/default.pkg](/home/jackpridham/Work/vesta-vxapp/install/debian/13/packages/default.pkg)
- [example-of-linux-root-folder/usr/local/vesta/data/packages/default.pkg](/home/jackpridham/Work/vesta-vxapp/example-of-linux-root-folder/usr/local/vesta/data/packages/default.pkg)
- [example-of-linux-root-folder/usr/local/vesta/data/users/admin/user.conf](/home/jackpridham/Work/vesta-vxapp/example-of-linux-root-folder/usr/local/vesta/data/users/admin/user.conf)
- [example-of-linux-root-folder/usr/local/vesta/data/users/test/user.conf](/home/jackpridham/Work/vesta-vxapp/example-of-linux-root-folder/usr/local/vesta/data/users/test/user.conf)

The companion sanitized snapshot is [.docs/audits/2026-06-27-docker-panel-management-task3.audit-input.md](/home/jackpridham/Work/vesta-vxapp/.docs/audits/2026-06-27-docker-panel-management-task3.audit-input.md).
