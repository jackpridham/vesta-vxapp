...
This audit validates Task 6 of [.docs/plans/2026-06-27-docker-panel-management.md](/path/to/vesta-vxapp/.docs/plans/2026-06-27-docker-panel-management.md) against the landed Docker panel controllers, AJAX handlers, helpers, templates, JavaScript, and supporting CLI seams:
...
- [web/start/docker/index.php](/path/to/vesta-vxapp/web/start/docker/index.php)
- [web/stop/docker/index.php](/path/to/vesta-vxapp/web/stop/docker/index.php)
- [web/restart/docker/index.php](/path/to/vesta-vxapp/web/restart/docker/index.php)
- [web/delete/docker/index.php](/path/to/vesta-vxapp/web/delete/docker/index.php)
- [web/ajax/docker/index.php](/path/to/vesta-vxapp/web/ajax/docker/index.php)
- [web/ajax/docker/router.php](/path/to/vesta-vxapp/web/ajax/docker/router.php)
- [web/ajax/docker/actions/install.php](/path/to/vesta-vxapp/web/ajax/docker/actions/install.php)
- [web/ajax/docker/actions/logs.php](/path/to/vesta-vxapp/web/ajax/docker/actions/logs.php)
- [web/ajax/docker/actions/inspect.php](/path/to/vesta-vxapp/web/ajax/docker/actions/inspect.php)
- [web/ajax/docker/actions/remove.php](/path/to/vesta-vxapp/web/ajax/docker/actions/remove.php)
- [web/ajax/docker/actions/stats.php](/path/to/vesta-vxapp/web/ajax/docker/actions/stats.php)
- [web/ajax/docker/actions/health.php](/path/to/vesta-vxapp/web/ajax/docker/actions/health.php)
- [web/ajax/docker/actions/alerts.php](/path/to/vesta-vxapp/web/ajax/docker/actions/alerts.php)
- [web/ajax/docker/actions/acknowledge_alert.php](/path/to/vesta-vxapp/web/ajax/docker/actions/acknowledge_alert.php)
...
- [web/js/pages/edit_docker.js](/path/to/vesta-vxapp/web/js/pages/edit_docker.js)
...
The companion sanitized snapshot is [.docs/audits/2026-06-27-docker-panel-management-task6.audit-input.md](/path/to/vesta-vxapp/.docs/audits/2026-06-27-docker-panel-management-task6.audit-input.md).
